...
export const TASK_CORRIDORS: Record<TaskCorridorId, TaskCorridor> = {
  "yard-to-b03": {
    ...
    color: "#e4c46b",
    focus: [112, 1.2, 35],
    points: [[-112, 1, 110], [-108, 1, 121], [-60, 1, 126], [30, 1, 124], [80, 1, 120], [108, 1, 102], [112, 1, 70], [112, 1, 35]],
  },
  "central-patrol": {
    id: "central-patrol",
    label: "A03、B02 巡检走廊",
    color: "#76d5c3",
    focus: [78, 1.2, -19],
    points: [[-106, 1, 103], [-140, 1, 110], [-162, 1, 55], [-164, 1, -8], [-150, 1, -19], [-82, 1, -21], [-10, 1, -22], [63, 1, -20], [78, 1, -19], [64, 1, 0], [60, 1, 24]],
  },
  "east-maintenance": {
    id: "east-maintenance",
    label: "泵站与渠道维护带",
